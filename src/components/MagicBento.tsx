      ...
      >
        <div className={`card-responsive grid gap-3`}>
          {cards.map((card, index) => {
            const baseClassName = `card flex flex-col justify-between relative w-full h-full max-w-full p-4 rounded-[20px] border border-solid font-light overflow-hidden transition-all duration-300 ease-in-out hover:-translate-y-0.5 hover:shadow-[0_8px_25px_rgba(0,0,0,0.15)] ${
              ...
              const cardContent = (
                ...
                >
                  ...
                  <div className="card__content flex flex-col flex-1 relative text-white">
                    {card.title && (
                      <h3
                        className={`card__title font-semibold text-xl m-0 mb-2 pb-[3px] ${textAutoHide ? "text-clamp-1" : ""}`}
                      >
                        {card.title}
                      </h3>
                    )}
            ...
            const cardContent = (
              ...
              >
                ...
                <div className="card__content flex flex-col relative text-white">
                  ...
                  <h3
                    className={`card__title font-normal text-base m-0 pb-[3px] ${
...
const StyledBentoSection = styled.div<{
  ...
  .card--border-glow::after {
    ...
    background: radial-gradient(
      ...
      rgba(${(props) => props.$glowColor}, calc(var(--glow-intensity) * 0.8)) 0%,
      rgba(${(props) => props.$glowColor}, calc(var(--glow-intensity) * 0.4))
        30%,
      transparent 60%
    );
  ...
  .particle::before {
    ...
    right: -2px;
    bottom: -2px;
    background: rgba(${(props) => props.$glowColor}, 0.2);
    border-radius: 50%;
    z-index: -1;
  }
