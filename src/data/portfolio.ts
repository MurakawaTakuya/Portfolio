...
export const portfolioData: PortfolioData = {
  ...
  skills: {
    frontend: [
      { name: "Next.js", level: 4, iconName: "next" },
    ...
    infrastructure: [
      ...
      { name: "Vercel", level: 4, iconName: "vercel" },
      { name: "Supabase", level: 4, iconName: "supabase" },
    ...
    editor: [
      ...
      { name: "Cursor", level: 5, iconName: null },
      { name: "Antigravity", level: 5, iconName: null },
      { name: "Atom", level: 5, iconName: "atom" },
      { name: "Eclipse", level: 5, iconName: "eclipse" },
    ],
    os: [
      { name: "Windows", level: 5, iconName: "windows" },
